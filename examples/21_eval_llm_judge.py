...
Usage::
    ...
    uv run python examples/21_eval_llm_judge.py
    uv run python examples/21_eval_llm_judge.py --model gpt-5.5 --provider openai
"""
...
async def _main() -> None:
    ...
    experiment = Experiment(
        ...
        sampling=SamplingParams(temperature=0.3, max_tokens=80),
    )
