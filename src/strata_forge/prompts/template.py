...
adjacent modules in :mod:`strata_forge.prompts` handle the orthogonal concerns:

- Per-provider cache markers — :mod:`strata_forge.prompts.cache_aware`
- Variable extraction and validation — :mod:`strata_forge.prompts.variables`
- Rendering to :class:`strata_forge.llm.AnyMessage` — :mod:`strata_forge.prompts.rendering`
...
class PromptError(ForgeError):
    """Base class for errors raised from :mod:`strata_forge.prompts`."""
