...
function, so importing :mod:`strata_forge.datasets.hf_bridge` works without
...
def _import_datasets() -> Any:
    try:
        ...
        msg = "The [hf] extra is required for hf_bridge. Install it with: pip install 'strata-forge[hf]'."
