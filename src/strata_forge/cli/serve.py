...
from strata_forge.cli.helpers import error_exit, run_async
...
def tgi_cmd(
    ...
    from strata_forge.compute.serving import build_tgi_task
...
def sglang_cmd(
    ...
    from strata_forge.compute.serving import build_sglang_task
...
async def _submit_local(task: object, base_url: str) -> None:
    from strata_forge.cli import compute as compute_cli
