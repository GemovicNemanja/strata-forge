...
- Route resolution via :mod:`strata_forge.llm.routing` + :mod:`strata_forge.llm.registry`.
- Provider-agnostic response cache (:mod:`strata_forge.llm.cache`).
- Two-axis fallback + per-call retry (:mod:`strata_forge.llm.fallback` +
  :mod:`strata_forge.core.retry`).
- Structured output (:mod:`strata_forge.llm.schemas`).
...
from strata_forge.llm.errors import map_litellm_exception
...
from strata_forge.llm.streaming import StreamingToolCallAccumulator
from strata_forge.llm.tools import AnyTool, Tool, ToolDeclaration, ToolLoopExceededError
...
class LLMClient:
    ...
    async def run_tool_loop(
        ...
        *,
        ...
        :class:`~strata_forge.llm.tools.ToolDeclaration` has no function to
    ...
    async def stream_tool_loop(
        ...
        *,
        ...
        yields a flat stream of :data:`~strata_forge.llm.loop_events.LoopEvent`
        ...
        :class:`~strata_forge.llm.tools.ToolDeclaration`\\ s — tools the caller
