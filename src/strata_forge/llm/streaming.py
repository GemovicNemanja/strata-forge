...
Higher-level helpers in ``strata_forge.llm.client`` wrap these into the public
streaming API.
"""
...
if TYPE_CHECKING:
    ...
    from strata_forge.llm.responses import ResponseChunk, ToolCallDelta
...
class StreamingToolCallAccumulator:
    ...
    multi-turn streaming tool loop in :mod:`strata_forge.llm.client`
