...
:mod:`strata_forge.rag` lands its Qdrant backend, any
...
from strata_forge.agents.memory.vector_store import VectorItem

if TYPE_CHECKING:
    from collections.abc import Awaitable, Callable, Mapping, Sequence

    from strata_forge.agents.memory.vector_store import VectorSearchResult, VectorStore
