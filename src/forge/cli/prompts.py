...
picked from :func:`forge.cli.helpers.prompt_store_from_settings`,
...
from forge.cli.helpers import error_exit, prompt_store_from_settings, run_async
...
async def _show(name: str, version: str | None) -> None:
    from forge.prompts.registry import PromptNotFoundError, PromptRegistry
