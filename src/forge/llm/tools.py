...
``forge.llm.providers.{openai,anthropic,vertex}``; :class:`Tool` delegates
...
from forge.llm.providers.openai import to_openai_tool_schema
from forge.llm.providers.vertex import to_gemini_tool_schema
