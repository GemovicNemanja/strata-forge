...
lazily inside the constructor so ``import forge.rag`` works without
...
from forge.rag.vector_store import VectorItem, VectorSearchResult
...
class QdrantVectorStore:
    """Qdrant-backed :class:`forge.rag.VectorStore`.
