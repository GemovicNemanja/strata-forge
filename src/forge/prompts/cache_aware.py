...
:mod:`forge.prompts.rendering` — the result is a
...
class StableDynamicSplit:
    ...
    def build(cls, *, stable_text: str, dynamic_text: str) -> StableDynamicSplit:
        ...
        The standard way to build a split — :func:`forge.core.repro.content_hash`
    ...
    *,
    ...
    Args:
        ...
        model: Logical model name passed through to
            :func:`forge.llm.tokens.count_tokens` for accurate tokenization.
