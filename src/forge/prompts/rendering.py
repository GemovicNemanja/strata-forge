...
1. Validate the template's variable declarations
   (:func:`forge.prompts.variables.validate_template_variables`).
...
hand-off to :class:`forge.llm.LLMClient`. The LLM client consumes the
...
class RenderedPrompt:
    ...
    :class:`forge.llm.LLMClient`. ``cache_hints`` carries the
    ...
    *,
    ...
    Args:
        ...
        model: Logical model name passed through to
            :func:`forge.prompts.cache_aware.emit_cache_hints` for
        ...
        min_cacheable_tokens: Threshold below which the stable prefix
            ...
            :data:`forge.prompts.cache_aware.DEFAULT_MIN_CACHEABLE_TOKENS`.
