...
The wrapped function is decorated with :func:`forge.llm.tool` so it
plugs into :class:`forge.agents.Agent` directly:

.. code-block:: python

    from forge.agents import Agent
    from forge.agents.tools import calculator
