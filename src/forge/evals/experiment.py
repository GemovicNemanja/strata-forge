...
from forge.llm.responses import Usage  # noqa: TC001 — Pydantic needs runtime resolution
...
class SamplingParams(BaseModel):
    ...
    identical content hashes. Defaults match :mod:`forge.llm`'s own
...
class Experiment(BaseModel):
    ...
    :mod:`forge.llm`, :mod:`forge.prompts`, and :mod:`forge.datasets`.
